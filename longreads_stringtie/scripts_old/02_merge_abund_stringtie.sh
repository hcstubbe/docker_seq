...
find /mnt/0/ -mindepth 1 -maxdepth 1 -type d -exec stringtie -e -B -L -p $NTHREADS -G $OUTPUTFOLDER/stringtie_merged.gtf -o {}/input_ballgown/abund.gtf {}/output_samtools/alns.sorted.BAM \;
